...
public class IceClient {
	public static void main(String[] args) {
		...
		try {
			...
			ObjectPrx base2 = communicator.propertyToProxy("Calc1.Proxy");
            if(base1 == null) { //powyższa opcja się nie uda, gdy nie był wskazany plik konfiguracyjny (--Ice.Config=client.config)
                ...
                base1 = communicator.stringToProxy("calc/calc11:tcp -h 127.0.0.2 -p 10009 -z : udp -h 127.0.0.2 -p 10009 -z"); //opcja -z włącza możliwość kompresji wiadomości
            	base2 = communicator.stringToProxy("calc/calc33:tcp -h 127.0.0.2 -p 10009 -z : udp -h 127.0.0.2 -p 10009 -z");
			}
				...
				try {
					...
					switch (line) {
						case "add":
							r = obj1.add(7, 8);
							r2 = obj2.add(7, 8);
							System.out.println("RESULT = " + r + " " + r2);
							break;
						case "add2":
						...
						case "avg":
							long[] input = {3, 11, 7, 2};
							System.out.println("AVG = " + obj1.avg(input));
							break;
